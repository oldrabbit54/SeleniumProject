...
def test_buy_product(test_runner):
    ...
    pa.buy()
    pa.assert_order()
    pa.finish_order('AAAAAA', 'AAAAA', '+79124567788', 'Тюмень', 'Кулибина',
                   '1', '1', 'ЮMoney')
    #pa.assert_success_order() does not work yet because problem of login window pop-up is not solved